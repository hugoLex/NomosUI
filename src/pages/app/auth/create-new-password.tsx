  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if ((error as { data: { token: string[] } })?.data.token) {
        setErrorMsg((error as { data: { token: string[] } })?.data.token[0]);
      }
      console.log(error);
    }
  };
            ...
            <div className=" max-w-[25.6875rem] md:w-[25.6875rem] mx-auto max-lg:pl-[2.51rem] max-lg:pr-[3.11rem] bg-white ">
              ...
              >
                <Form>
                  ...
                  <div className="relative  items-center mt-[3.37rem]">
                    ...
                    <button
                      ...
                      className={` ${
                        errorMessage === "Invalid token." && "hidden"
                      } mt-5 w-full h-[3.05231rem] md:h-[3.25rem] px-4 py-2 tracking-wide text-white  bg-blue_btn disabled:cursor-not-allowed rounded-[5px]  focus:outline-none relative`}
                    >
