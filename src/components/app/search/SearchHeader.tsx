  ...
  return (
    <>
      <div className='border-b border-solid bg-stone-50 border-stone-300 border-opacity-50 rounded-t-lg'>
        <div
          className='flex gap-5 justify-between md:justify-end items-center px-4 py-2.5 w-full relative
         max-md:flex-wrap max-md:max-w-full'>
          <SearchButtonBox className='md:absolute md:left-1/3 md:-translate-x-1/3' />
