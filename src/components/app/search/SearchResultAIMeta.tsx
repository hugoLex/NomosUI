...
const SearchAIMetaResult = () => {
  return (
    <div className="p-4 bg-[#F3F3EE] rounded-lg flex-col justify-start items-start inline-flex">
              ...
              <div className="flex-col justify-start items-start inline-flex">
                ...
                <div className="self-stretch  flex-col justify-start items-start flex">
                  <div className="text-zinc-600 text-sm font-normal  leading-tight">
                    Set of rules created and enforced by social or governmental
                    institutions
                  </div>
                </div>
              </div>
