      ...
      >
                ...
                <TooltipTrigger
                  onClick={() => {
                    ...
                    router.push({
                      pathname: "/search",
                      query: {
                        q: trendingSearches[0].text,
                      },
                    });
                  }}
                >
                  <span className="hover:bg-gray-100 p-1 rounded-md text-gray-900 truncate max-w-md">
                    {trendingSearches[0]?.text}
                  </span>
                </TooltipTrigger>
                <TooltipContent>
                  <p>{trendingSearches[0]?.text}</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
        ...
        >
          <div className="p-3 pt-0">
            {trendingSearches.slice(1).map((search, sdx) => (
              <div
                key={sdx}
                onClick={() => {
                  console.log("clicked");
