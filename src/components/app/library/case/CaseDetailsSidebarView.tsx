    ...
    <Fragment>
      {caseDocument && (
        <Fragment>
          ...
          <div className="absolute pt-[30px]  top-0 bottom-0 left-auto h-[calc(100vh-100px)] overflow-y-auto scrollbar space-y-4 text-dark-2 font-rubik pb-[200px] pr-[0.875rem]">
